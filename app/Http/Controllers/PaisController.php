...
class PaisController extends AppBaseController
{
    ...
    public function store(CreatePaisRequest $request)
    {
        ...
        Flash::success(__('messages.saved', ['model' => __('models/pais.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($pais)) {
            Flash::error(__('messages.not_found', ['model' => __('models/pais.singular')]));
    ...
    public function update($id, UpdatePaisRequest $request)
    {
        ...
        Flash::success(__('messages.updated', ['model' => __('models/pais.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('messages.deleted', ['model' => __('models/pais.singular')]));
