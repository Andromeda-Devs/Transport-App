...
class DocumentoController extends AppBaseController
{
    ...
    public function store(CreateDocumentoRequest $request)
    {
        ...
        Flash::success(__('messages.saved', ['model' => __('models/documentos.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($documento)) {
            Flash::error(__('messages.not_found', ['model' => __('models/documentos.singular')]));
    ...
    public function update($id, UpdateDocumentoRequest $request)
    {
        ...
        Flash::success(__('messages.updated', ['model' => __('models/documentos.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('messages.deleted', ['model' => __('models/documentos.singular')]));
