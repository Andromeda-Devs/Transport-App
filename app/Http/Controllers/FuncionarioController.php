...
class FuncionarioController extends AppBaseController
{
    ...
    public function store(CreateFuncionarioRequest $request)
    {
        ...
        Flash::success(__('messages.saved', ['model' => __('models/funcionarios.singular')]));
    ...
    public function show($id)
    {
        ...
        if (empty($funcionario)) {
            Flash::error(__('messages.not_found', ['model' => __('models/funcionarios.singular')]));
    ...
    public function update($id, UpdateFuncionarioRequest $request)
    {
        ...
        Flash::success(__('messages.updated', ['model' => __('models/funcionarios.singular')]));
    ...
    public function destroy($id)
    {
        ...
        Flash::success(__('messages.deleted', ['model' => __('models/funcionarios.singular')]));
